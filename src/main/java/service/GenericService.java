...
public class GenericService<T> {
    ...
    public GenericService(HttpServletRequest request, HttpServletResponse response) {
    ...
    /**
     * Load danh sách các đối tượng khác lên web theo từng page
     * với page size là 5
     */
    public void loadListInPageNumber(List<Object> list, String listName) {
        ...
        try {
            for (Field field : fields) {
                ...
                if (parameterValue != null && !parameterValue.isEmpty()) {
                    if (parameterValue.equals(IMAGE_FIELD)) {
